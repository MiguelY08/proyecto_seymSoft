      ...
      <main className="mx-auto max-w-[var(--store-content-max)] px-[var(--store-content-x)] py-8">
        <div className="mb-7 flex flex-wrap items-center gap-3 rounded-3xl border border-slate-200 bg-white p-4 shadow-sm">
          <button
            ...
            className="flex items-center gap-2 rounded-full border border-slate-200 px-4 py-2 text-xs font-black text-slate-600 transition hover:border-[#004D77]/30 hover:bg-[#004D77]/10 hover:text-[#004D77] active:scale-95"
          >
