...
/**
 *
 * @param {string} sidebarOption   - Primera parte del breadcrumb (ej: "Ventas")
 * @param {string} submenuOption   - Segunda parte del breadcrumb (ej: "Historial")
...
export default function HeaderSidebar({
  ...
  // Nombre corto para la topbar (ej: "Yorman Alirio O...")
  const shortName =
  ...
  <header className="w-full h-14 flex items-center justify-between px-5 bg-[#F0F0F0] border-b border-slate-200 shrink-0">
    ...
    <div className="flex items-center gap-2 text-slate-600">
      <div className="w-7 h-7 rounded border border-slate-300 flex items-center justify-center bg-slate-50">
    ...
    <div className="relative" ref={dropdownRef}>
      ...
      {/* ── Dropdown ──────────────────────────────────── */}
      {menuOpen && (
        <div className="absolute right-0 mt-2 w-64 bg-white rounded-xl shadow-xl border border-slate-200 z-50 overflow-hidden cursor-pointer">
