...
function ProductCard({ image, name, category, price, productId, onAddToCart, onAddToFavorites }) {
  ...
  const handleFavorite = (e) => {
    ...
    if (adding) onAddToFavorites?.(); // Solo dispara el callback al AGREGAR
  };
  ...
  return (
    <Link
      ...
      className="bg-white rounded-2xl border-2 border-gray-200 transition-all duration-200 hover:shadow-lg hover:border-gray-300 overflow-hidden block"
    >
      {/* Imagen del producto */}
