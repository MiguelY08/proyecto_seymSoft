 ...
 const mockReports = [
  {
    ...
    codigoBarras: "0124532",
    categoria: "Útiles Escolares",
    cantidadAfectada: 7,
    fechaDeteccion: "21/10/25",
    motivo: "Hojas dobladas",
    estado: "Activo",
  },
  {
    id: 2,
    nombre: "Calculadora Casio",
    codigoBarras: "1023634",
    categoria: "Útiles Escolares",
    cantidadAfectada: 3,
    fechaDeteccion: "21/10/25",
    motivo: "Partida",
  ...
  {
    id: 3,
    nombre: "Resaltadores Stabilo x5",
    codigoBarras: "4587963",
    categoria: "Papelería",
    cantidadAfectada: 5,
    fechaDeteccion: "20/10/25",
    motivo: "Secos",
    estado: "Activo",
  },
  {
    id: 4,
    nombre: "Marcador Permanente Sharpie",
    codigoBarras: "7745123",
    categoria: "Papelería",
    cantidadAfectada: 2,
    fechaDeteccion: "19/10/25",
    motivo: "Sin tinta",
    estado: "Anulado",
  },
  {
    ...
    codigoBarras: "8896321",
    categoria: "Oficina",
    cantidadAfectada: 10,
    fechaDeteccion: "18/10/25",
    motivo: "Rota",
    estado: "Activo",
  },
  {
    id: 6,
    nombre: "Bolígrafos Bic Azul x12",
    codigoBarras: "6654789",
    categoria: "Papelería",
    cantidadAfectada: 4,
    fechaDeteccion: "17/10/25",
    motivo: "Tinta corrida",
    estado: "Activo",
  },
  {
    id: 7,
    nombre: "Regla Metálica 30cm",
    codigoBarras: "3214789",
    categoria: "Útiles Escolares",
    cantidadAfectada: 1,
    fechaDeteccion: "16/10/25",
    motivo: "Doblada",
    estado: "Anulado",
  },
  {
    id: 8,
    nombre: "Corrector Líquido Pelikan",
    codigoBarras: "9987456",
    categoria: "Papelería",
    cantidadAfectada: 6,
    fechaDeteccion: "15/10/25",
    motivo: "Derramado",
    estado: "Activo",
  },
  {
    ...
    codigoBarras: "5478963",
    categoria: "Útiles Escolares",
    cantidadAfectada: 2,
    fechaDeteccion: "14/10/25",
    motivo: "Sin filo",
    estado: "Activo",
  },
  {
    id: 10,
    nombre: "Archivador AZ Tamaño Carta",
    codigoBarras: "7412589",
    categoria: "Oficina",
    cantidadAfectada: 8,
    fechaDeteccion: "13/10/25",
    motivo: "Anillas dañadas",
    estado: "Anulado",
  },
];
  ...
  useEffect(() => {
    ...
    if (
      ...
      showInfo(
        "Sin resultados",
        "No se encontraron reportes con el filtro aplicado."
      );
