...
export default function AccountHeader({
  ...
  const pctOcupado = credAsignado > 0
      ...
      <div className="flex flex-col items-start lg:items-end gap-4">
        ...
        <div className="flex flex-wrap gap-3 justify-start lg:justify-end">
          ...
          <div className="bg-gray-50 border border-gray-200 rounded-xl px-4 py-2 text-center min-w-[130px]">
            ...
            <p className={`text-base font-bold ${cupoOcupado > 0 ? "text-red-600" : "text-green-600"}`}>
            ...
            <p className="text-[10px] text-gray-400 mt-0.5">{pctOcupado}% del cupo</p>
          </div>

          {/* Cupo Disponible */}
          <div className="bg-gray-50 border border-gray-200 rounded-xl px-4 py-2 text-center min-w-[130px]">
            <p className="text-xs text-gray-400">Cupo Disponible</p>
            <p className={`text-base font-bold ${cupoDisponible > 0 ? "text-green-600" : "text-gray-400"}`}>
          ...
          {interes > 0 && (
            <div className="bg-orange-50 border border-orange-200 rounded-xl px-4 py-2 text-center min-w-[130px]">
              ...
              <p className="text-[10px] text-orange-300 mt-0.5">No consume cupo</p>
            </div>
          )}
          ...
          {interes > 0 && (
            <div className="bg-red-50 border border-red-200 rounded-xl px-4 py-2 text-center min-w-[130px]">
              ...
              <p className="text-[10px] text-red-300 mt-0.5">Capital + interés</p>
            </div>
          )}

        </div>

        {/* Botón PDF — solo en mode="view" */}
        {mode === "view" && (
          <ButtonComponent
