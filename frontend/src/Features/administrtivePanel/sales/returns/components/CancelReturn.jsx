      ...
      <div onClick={(e) => e.stopPropagation()} className="flex h-dvh w-full max-w-3xl flex-col overflow-hidden bg-white shadow-2xl sm:h-auto sm:max-h-[90vh] sm:rounded-3xl">
        ...
        <div className="overflow-y-auto flex-1">
          <div className="grid grid-cols-1 divide-y divide-gray-200 md:grid-cols-2 md:divide-x md:divide-y-0">
            ...
            <div className="flex flex-col overflow-x-auto px-4 py-5 sm:px-6">
              <p className="text-sm font-bold text-gray-700 mb-3">Productos devueltos</p>

              {productos.length > 0 ? (
                <>
                  <div className="grid min-w-[360px] grid-cols-[1fr_auto_auto_auto] gap-x-3 border-b-2 border-gray-200 pb-1.5 mb-1">
                  ...
                  <div className="mb-4 flex min-w-[360px] flex-1 flex-col divide-y divide-gray-100">
