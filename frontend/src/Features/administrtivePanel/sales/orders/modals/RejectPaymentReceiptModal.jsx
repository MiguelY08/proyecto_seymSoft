          ...
          <div className="space-y-4">
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <textarea
                ...
                className={`w-full resize-none rounded-lg border bg-white px-3 py-2.5 text-sm text-gray-700 outline-none transition focus:border-[#004D77] focus:ring-2 focus:ring-[#004D77]/20 disabled:bg-gray-100 ${
